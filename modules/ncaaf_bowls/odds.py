...
def get_spreads():
    """Get NCAAF spreads from Odds API."""
    return odds_client.get_odds(config.SPORT_KEYS["ncaaf"], markets="spreads")


def find_game_spread(odds_events, game):
    """Find spread data for a game.
    ...
    best_by_team = {}  # team_name -> (spread, odds, book)
    all_odds_by_team = {}
